...
const podcastRec: Record<PodcastTypes, PodcastEpisode[]> = {
  typePlatypus: [
    ...
    },
    {
      episode: 11,
      title: "如何在澳洲找到第一份工作",
      titleEn: "First job in Australia.",
    ...
    {
      episode: 17,
      title: "留學生自媒體經營 feat. Sammy",
      titleEn: "Running social media.",
  ...
  typeKoala: [
    {
      ...
      titleEn: "Cairns Great Barrier Reef.",
